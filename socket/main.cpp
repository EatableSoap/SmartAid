...
int main() {
    ...
    queryAttribution["TableName"] = "DoctorAppointmentInfo";
    queryAttribution["SelectColumn"] = QJsonArray::fromStringList(QStringList() << "DoctorDiagnosis"<<"Prescription"<<"Orders");
    queryAttribution["ConditionColumn"] = "AppointmentID";
    queryAttribution["ConditionValue"] = "100";

    QSqlQuery* queryResult = DataBaseInterface::ServerQuery(queryAttribution);
    ...
    QString insertResult = DataBaseInterface::ServerInsert(insertAttribution);
    qDebug() << insertResult;
    ...
    QString updateResult = DataBaseInterface::ServerUpdate(updateAttribution);
    qDebug() << updateResult;

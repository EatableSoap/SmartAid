...
#include "../SDK/MaterialSDK/components/qtmaterialprogress.h"
...
QT_INIT_METAOBJECT const QMetaObject QtMaterialProgress::staticMetaObject = { {
    &QProgressBar::staticMetaObject,
    qt_meta_stringdata_QtMaterialProgress.data,

...
#include "../SDK/MaterialSDK/components/qtmaterialscrollbar_internal.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QtMaterialScrollBarStateMachine_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QtMaterialScrollBarStateMachine_t qt_meta_stringdata_QtMaterialScrollBarStateMachine = {
    {
QT_MOC_LITERAL(0, 0, 31), // "QtMaterialScrollBarStateMachine"
QT_MOC_LITERAL(1, 32, 7) // "opacity"

    },
    "QtMaterialScrollBarStateMachine\0opacity"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_QtMaterialScrollBarStateMachine[] = {
...
QT_INIT_METAOBJECT const QMetaObject QtMaterialScrollBarStateMachine::staticMetaObject = { {
    &QStateMachine::staticMetaObject,
    qt_meta_stringdata_QtMaterialScrollBarStateMachine.data,

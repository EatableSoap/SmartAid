...
public:
    ...
    void setupUi(QWidget *patientinfor)
    {
        ...
        formLayoutWidget->setGeometry(QRect(50, 60, 861, 429));
        ...
        horizontalLayoutWidget->setGeometry(QRect(240, 450, 498, 69));
...
"}"));
        ...
        QObject::connect(exit, SIGNAL(clicked()), patientinfor, SLOT(close()));
    ...
    void retranslateUi(QWidget *patientinfor)
    {
        ...
        pushButton->setText(QApplication::translate("patientinfor", "\345\257\206\347\240\201\346\233\264\346\224\271", nullptr));

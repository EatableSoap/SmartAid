...
#include "../SDK/MaterialSDK/components/qtmaterialslider.h"
...
QT_INIT_METAOBJECT const QMetaObject QtMaterialSlider::staticMetaObject = { {
    &QAbstractSlider::staticMetaObject,
    qt_meta_stringdata_QtMaterialSlider.data,

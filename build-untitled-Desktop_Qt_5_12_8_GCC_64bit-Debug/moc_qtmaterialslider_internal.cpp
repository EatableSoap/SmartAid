...
#include "../SDK/MaterialSDK/components/qtmaterialslider_internal.h"
...
QT_INIT_METAOBJECT const QMetaObject QtMaterialSliderStateMachine::staticMetaObject = { {
    &QStateMachine::staticMetaObject,
    qt_meta_stringdata_QtMaterialSliderStateMachine.data,
...
QT_INIT_METAOBJECT const QMetaObject QtMaterialSliderThumb::staticMetaObject = { {
    &QtMaterialOverlayWidget::staticMetaObject,
    qt_meta_stringdata_QtMaterialSliderThumb.data,
...
QT_INIT_METAOBJECT const QMetaObject QtMaterialSliderTrack::staticMetaObject = { {
    &QtMaterialOverlayWidget::staticMetaObject,
    qt_meta_stringdata_QtMaterialSliderTrack.data,

...
#include "../SDK/MaterialSDK/components/qtmaterialappbar.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QtMaterialAppBar_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QtMaterialAppBar_t qt_meta_stringdata_QtMaterialAppBar = {
    {
QT_MOC_LITERAL(0, 0, 16), // "QtMaterialAppBar"
QT_MOC_LITERAL(1, 17, 15), // "foregroundColor"
QT_MOC_LITERAL(2, 33, 15) // "backgroundColor"

    },
    "QtMaterialAppBar\0foregroundColor\0"
    "backgroundColor"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_QtMaterialAppBar[] = {
...
QT_INIT_METAOBJECT const QMetaObject QtMaterialAppBar::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_QtMaterialAppBar.data,

/********************************************************************************
** Form generated from reading UI file 'patientpap.ui'
**
...
#ifndef UI_PATIENTPAP_H
#define UI_PATIENTPAP_H
...
public:
    ...
    void setupUi(QWidget *patientPAP)
    {
        if (patientPAP->objectName().isEmpty())
            patientPAP->setObjectName(QString::fromUtf8("patientPAP"));
        patientPAP->resize(1239, 945);
        exit = new QPushButton(patientPAP);
        exit->setObjectName(QString::fromUtf8("exit"));
        exit->setGeometry(QRect(520, 850, 211, 81));
...
"}\n"
""));
        horizontalLayoutWidget = new QWidget(patientPAP);
        horizontalLayoutWidget->setObjectName(QString::fromUtf8("horizontalLayoutWidget"));
        horizontalLayoutWidget->setGeometry(QRect(840, 100, 234, 80));
        ...
        horizontalLayoutWidget_2 = new QWidget(patientPAP);
        horizontalLayoutWidget_2->setObjectName(QString::fromUtf8("horizontalLayoutWidget_2"));
        horizontalLayoutWidget_2->setGeometry(QRect(60, 100, 274, 80));
        ...
        label_2 = new QLabel(patientPAP);
        label_2->setObjectName(QString::fromUtf8("label_2"));
        label_2->setGeometry(QRect(60, 190, 129, 34));
        notice = new QLineEdit(patientPAP);
        notice->setObjectName(QString::fromUtf8("notice"));
        notice->setGeometry(QRect(60, 230, 1031, 251));
        label_3 = new QLabel(patientPAP);
        label_3->setObjectName(QString::fromUtf8("label_3"));
        label_3->setGeometry(QRect(60, 480, 129, 34));
        order = new QLineEdit(patientPAP);
        order->setObjectName(QString::fromUtf8("order"));
        order->setGeometry(QRect(60, 520, 1031, 291));
        horizontalLayoutWidget_3 = new QWidget(patientPAP);
        horizontalLayoutWidget_3->setObjectName(QString::fromUtf8("horizontalLayoutWidget_3"));
        horizontalLayoutWidget_3->setGeometry(QRect(440, 100, 331, 80));
        ...
        number = new QLineEdit(horizontalLayoutWidget_3);
        number->setObjectName(QString::fromUtf8("number"));

        horizontalLayout_3->addWidget(number);


        retranslateUi(patientPAP);
        QObject::connect(exit, SIGNAL(clicked()), patientPAP, SLOT(close()));

        QMetaObject::connectSlotsByName(patientPAP);
    } // setupUi

    void retranslateUi(QWidget *patientPAP)
    {
        patientPAP->setWindowTitle(QApplication::translate("patientPAP", "Form", nullptr));
        exit->setText(QApplication::translate("patientPAP", "\351\200\200\345\207\272", nullptr));
        label_4->setText(QApplication::translate("patientPAP", "\347\274\264\350\264\271\351\207\221\351\242\235", nullptr));
        label->setText(QApplication::translate("patientPAP", "\346\227\245\346\234\237", nullptr));
        label_2->setText(QApplication::translate("patientPAP", "\345\214\273\345\230\261", nullptr));
        label_3->setText(QApplication::translate("patientPAP", "\345\244\204\346\226\271", nullptr));
        label_5->setText(QApplication::translate("patientPAP", "\351\242\204\347\272\246\345\217\267", nullptr));
    } // retranslateUi

};

namespace Ui {
    class patientPAP: public Ui_patientPAP {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_PATIENTPAP_H

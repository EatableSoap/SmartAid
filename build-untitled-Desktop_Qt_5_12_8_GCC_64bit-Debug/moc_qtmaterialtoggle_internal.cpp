...
#include "../SDK/MaterialSDK/components/qtmaterialtoggle_internal.h"
...
QT_INIT_METAOBJECT const QMetaObject QtMaterialToggleRippleOverlay::staticMetaObject = { {
    &QtMaterialRippleOverlay::staticMetaObject,
    qt_meta_stringdata_QtMaterialToggleRippleOverlay.data,
...
QT_INIT_METAOBJECT const QMetaObject QtMaterialToggleThumb::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_QtMaterialToggleThumb.data,
...
QT_INIT_METAOBJECT const QMetaObject QtMaterialToggleTrack::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_QtMaterialToggleTrack.data,

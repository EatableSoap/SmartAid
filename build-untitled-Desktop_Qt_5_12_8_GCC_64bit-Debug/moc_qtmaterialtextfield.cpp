...
#include "../SDK/MaterialSDK/components/qtmaterialtextfield.h"
...
QT_INIT_METAOBJECT const QMetaObject QtMaterialTextField::staticMetaObject = { {
    &QLineEdit::staticMetaObject,
    qt_meta_stringdata_QtMaterialTextField.data,

...
#include "../SDK/MaterialSDK/components/qtmaterialdialog.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QtMaterialDialog_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QtMaterialDialog_t qt_meta_stringdata_QtMaterialDialog = {
    {
QT_MOC_LITERAL(0, 0, 16), // "QtMaterialDialog"
QT_MOC_LITERAL(1, 17, 10), // "showDialog"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 10) // "hideDialog"

    },
    "QtMaterialDialog\0showDialog\0\0hideDialog"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_QtMaterialDialog[] = {
...
QT_INIT_METAOBJECT const QMetaObject QtMaterialDialog::staticMetaObject = { {
    &QtMaterialOverlayWidget::staticMetaObject,
    qt_meta_stringdata_QtMaterialDialog.data,

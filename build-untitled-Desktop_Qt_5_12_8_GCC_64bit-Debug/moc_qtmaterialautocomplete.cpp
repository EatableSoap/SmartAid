...
#include "../SDK/MaterialSDK/components/qtmaterialautocomplete.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QtMaterialAutoComplete_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QtMaterialAutoComplete_t qt_meta_stringdata_QtMaterialAutoComplete = {
    {
QT_MOC_LITERAL(0, 0, 22), // "QtMaterialAutoComplete"
QT_MOC_LITERAL(1, 23, 12), // "itemSelected"
QT_MOC_LITERAL(2, 36, 0), // ""
QT_MOC_LITERAL(3, 37, 13), // "updateResults"
QT_MOC_LITERAL(4, 51, 4) // "text"

    },
    "QtMaterialAutoComplete\0itemSelected\0"
    "\0updateResults\0text"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_QtMaterialAutoComplete[] = {
...
void QtMaterialAutoComplete::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->itemSelected((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->updateResults((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QtMaterialAutoComplete::itemSelected)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject QtMaterialAutoComplete::staticMetaObject = { {
    &QtMaterialTextField::staticMetaObject,
    qt_meta_stringdata_QtMaterialAutoComplete.data,

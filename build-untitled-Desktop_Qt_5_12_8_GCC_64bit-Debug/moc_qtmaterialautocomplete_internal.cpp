...
#include "../SDK/MaterialSDK/components/qtmaterialautocomplete_internal.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QtMaterialAutoCompleteStateMachine_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QtMaterialAutoCompleteStateMachine_t qt_meta_stringdata_QtMaterialAutoCompleteStateMachine = {
    {
QT_MOC_LITERAL(0, 0, 34), // "QtMaterialAutoCompleteStateMa..."
QT_MOC_LITERAL(1, 35, 10), // "shouldOpen"
QT_MOC_LITERAL(2, 46, 0), // ""
QT_MOC_LITERAL(3, 47, 11), // "shouldClose"
QT_MOC_LITERAL(4, 59, 10) // "shouldFade"

    },
    "QtMaterialAutoCompleteStateMachine\0"
    "shouldOpen\0\0shouldClose\0shouldFade"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_QtMaterialAutoCompleteStateMachine[] = {
...
void QtMaterialAutoCompleteStateMachine::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QtMaterialAutoCompleteStateMachine::shouldOpen)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (QtMaterialAutoCompleteStateMachine::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QtMaterialAutoCompleteStateMachine::shouldClose)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (QtMaterialAutoCompleteStateMachine::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QtMaterialAutoCompleteStateMachine::shouldFade)) {
                *result = 2;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject QtMaterialAutoCompleteStateMachine::staticMetaObject = { {
    &QStateMachine::staticMetaObject,
    qt_meta_stringdata_QtMaterialAutoCompleteStateMachine.data,

...
#include "../SDK/MaterialSDK/components/qtmaterialsnackbar.h"
...
QT_INIT_METAOBJECT const QMetaObject QtMaterialSnackbar::staticMetaObject = { {
    &QtMaterialOverlayWidget::staticMetaObject,
    qt_meta_stringdata_QtMaterialSnackbar.data,

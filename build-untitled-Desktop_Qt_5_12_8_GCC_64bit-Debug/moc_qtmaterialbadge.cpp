...
#include "../SDK/MaterialSDK/components/qtmaterialbadge.h"
...
QT_INIT_METAOBJECT const QMetaObject QtMaterialBadge::staticMetaObject = { {
    &QtMaterialOverlayWidget::staticMetaObject,
    qt_meta_stringdata_QtMaterialBadge.data,

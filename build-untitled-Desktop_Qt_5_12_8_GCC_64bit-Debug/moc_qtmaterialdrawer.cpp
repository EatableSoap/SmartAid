...
#include "../SDK/MaterialSDK/components/qtmaterialdrawer.h"
...
QT_INIT_METAOBJECT const QMetaObject QtMaterialDrawer::staticMetaObject = { {
    &QtMaterialOverlayWidget::staticMetaObject,
    qt_meta_stringdata_QtMaterialDrawer.data,

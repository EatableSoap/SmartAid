...
#include "../SmartAidUI/lib/socketClient.h"
...
#define QT_MOC_LITERAL(idx, ofs, len)                                       \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(                \
        len,                                                                \
        qptrdiff(offsetof(qt_meta_stringdata_socketClient_t, stringdata0) + \
...
static const qt_meta_stringdata_socketClient_t qt_meta_stringdata_socketClient =
    {{
     ...
     "socketClient\0onConnected\0\0onReadyRead"};
...
void socketClient::qt_static_metacall(QObject          *_o,
                                      QMetaObject::Call _c,
                                      int               _id,
                                      void            **_a)
{

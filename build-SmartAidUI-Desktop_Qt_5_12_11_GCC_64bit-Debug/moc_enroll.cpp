...
static const qt_meta_stringdata_Enroll_t qt_meta_stringdata_Enroll = {
    {
        ...
        QT_MOC_LITERAL(8, 107, 18)  // "on_choose2_clicked"

    },
    "Enroll\0switchToLast\0\0on_enroll_clicked\0"
    "on_password2_textEdited\0on_choose_clicked\0"
    "onExit\0on_choose1_clicked\0on_choose2_clicked"};
...
void Enroll::qt_static_metacall(QObject          *_o,
                                QMetaObject::Call _c,
                                int               _id,
                                void            **_a)
{
            ...
            switch (_id)
                {
                    case 0:
                        ...
                        break;
                    case 1:
                        _t->on_enroll_clicked();
                        break;
                    case 2:
                        _t->on_password2_textEdited();
                        break;
                    case 3:
                        _t->on_choose_clicked();
                        break;
                    case 4:
                        _t->onExit();
                        break;
                    case 5:
                        _t->on_choose1_clicked();
                        break;
                    case 6:
                        _t->on_choose2_clicked();
                        break;
                    default:;
                }
        }
    else if (_c == QMetaObject::IndexOfMethod)
        {
            int *result = reinterpret_cast<int *>(_a[0]);
            {
                ...
                if (*reinterpret_cast<_t *>(_a[1]) ==
                    static_cast<_t>(&Enroll::switchToLast))
                    {
                        *result = 0;
                        return;
                    }

...
class Machinetranslation : public AipBase
{
   public:
	...
	Machinetranslation(const std::string &app_id,
					   const std::string &ak,
					   const std::string &sk)
	 ...
	 */
	Json::Value texttrans_v1(std::string const &from,
							 std::string const &to,
							 std::string const &q,
	 ...
	 */
	Json::Value texttrans_with_dict_v1(std::string const &from,
									   std::string const &to,
									   std::string const &q,
									   const Json::Value &options)
	{
	 ...
	 */
	Json::Value doc_translation_create_v2(std::string const &from,
										  std::string const &to,
										  Json::Value		&options)
	{
		Json::Value data;
		...
		Json::Value result = this->request_com(_doc_translation_create_v2, data);
	 ...
	 * 接口使用文档链接: https://ai.baidu.com/ai-doc/MT/Xky9x5xub
	 */
	Json::Value doc_translation_query_v2(std::string const &id)
	{
		Json::Value data;
		data["id"] = id;
	 ...
	 */
	Json::Value speech_translation_v2(std::string const &from,
									  std::string const &to,
									  ...
									  std::string const &format)
	{
		...
		data["format"] = format;
		Json::Value result = this->request_com(_speech_translation_v2, data);
